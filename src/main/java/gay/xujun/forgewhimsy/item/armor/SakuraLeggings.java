...
public class SakuraLeggings extends ItemArmor {
    private static final ArmorMaterial SAKURA_LEGGINGS_MATERIAL = EnumHelper.addArmorMaterial(
    ...
    public SakuraLeggings(String name) {
        super(SAKURA_LEGGINGS_MATERIAL, 1, EntityEquipmentSlot.LEGS);
